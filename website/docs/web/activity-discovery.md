...
Explore the complete library of curated computer science activities. Filter by your needs or search by title.
...
Click any activity card to view detailed information.

### Metadata Fields

| Field | Description |
|-------|-------------|
| **Preparation Time** | Time needed to set up before the activity |
| **Cleanup Time** | Time needed to clean up afterward |
| **Format** | Unplugged, Digital, or Hybrid |
| **Bloom Level** | Cognitive complexity aligned to Bloom's taxonomy |
| **Mental Load** | Cognitive effort required (Low/Medium/High) |
| **Physical Energy** | Level of movement involved (Low/Medium/High) |
| **Required Materials** | Tools, devices, or supplies needed |

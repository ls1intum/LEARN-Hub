...
public class MetaController {
	...
	public ResponseEntity<?> getFieldValues() {
		...
		fieldValues.put("mentalLoad", Arrays.asList("low", "medium", "high"));
		fieldValues.put("physicalEnergy", Arrays.asList("low", "medium", "high"));
		fieldValues.put("priorityCategories",

...
public class ScoreResponse {
	...
	public ScoreResponse(int totalScore, Map<String, CategoryScoreResponse> categoryScores, boolean isSequence,
			int activityCount) {
	...
	public Map<String, CategoryScoreResponse> getCategoryScores() {

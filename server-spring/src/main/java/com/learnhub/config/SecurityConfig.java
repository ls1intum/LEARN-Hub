    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/hello", "/hello", "/api/openapi/**")
                        .permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/activities/", "/api/activities/*",
                                "/api/activities/*/pdf", "/api/activities/recommendations")
                        .permitAll()

                        // Admin-only activity endpoints
                        .requestMatchers(HttpMethod.POST, "/api/activities/", "/api/activities/upload-and-create")
                        .hasRole("ADMIN")
